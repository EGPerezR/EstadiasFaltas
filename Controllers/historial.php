...
while($historial = $busca->fetch_assoc()){
    ...
    echo "<td>";
    echo "<label>".$historial['Docente']." | ".$historial['grado']." de ".$espe." del ".$secc." <a style='color: red;'>(".$historial['Materia'].")</a></label>";
    echo "</td>";
    echo "</tr>";
}
}
